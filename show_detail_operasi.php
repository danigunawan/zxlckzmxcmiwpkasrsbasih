...
<div class="table-responsive">
  <table id="table-pelamar" class="table table-bordered table-sm">
   ...
   <?php 
   $query = $db->query("SELECT * FROM detail_operasi ");
...
<td> <button class='btn btn-warning btn-edit' data-id='". $data['id_detail_operasi'] ."'
  ...
  <span class='glyphicon glyphicon-edit'> </span> Edit </button> </td>
     ...
     <td> <button class='btn btn-danger delete' data-id='". $data['id_detail_operasi'] ."'
