...
<option value="<?php echo $aray['dokter_pengirim'];?>"><?php echo $aray['dokter_pengirim'];?></option>
  <?php 
    ...
    <div class="card card-block">
      ...
      <div class="row">
        ...
        <div class="col-sm-6">
          ...
          <a href='cetak_penjualan_tunai.php' id="cetak_tunai" style="display: none;" class="btn btn-primary sls" target="blank"> Cetak Tunai  </a>
          <a href='cetak_penjualan_tunai_kategori.php' id="cetak_tunai_kategori" style="display: none;" class="btn btn-primary sls" target="blank"> Cetak Tunai / Kategori   </a>

          <button type="submit" id="batal_penjualan" class="btn btn-danger" style="font-size:15px">  Batal (Ctrl + B)</button>


          <a href='cetak_penjualan_tunai_besar.php' id="cetak_tunai_besar" style="display: none;" class="btn btn-warning sls" target="blank"> Cetak Tunai  Besar </a>
    ...
    $.post("cek_total_seluruh_ranap.php",{no_reg:no_reg},function(data1){
        ...
        if (data1 == 1) {
                 $.post("cek_total_seluruh.php",{no_reg:no_reg},function(data){
                  var sum = parseInt(data,10) + parseInt(total_operasi,10);
      ...
      var total = parseInt(data,10) - parseInt(pot_fakt_rp,10) + parseInt(total_operasi,10);
      ...
      var total = parseInt(data,10) - parseInt(potongaaan,10) + parseInt(total_operasi,10);
                  $("#total1").val(tandaPemisahTitik(total))
            }
