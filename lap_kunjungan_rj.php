...
//berdasarkan no rm
        ...
        $.post("show_lap_kunjungan_rm.php", {no_rm:no_rm},function(info){
...
//berdasarkan tanggal
        ...
        $.post("show_lap_kunjungan_tanggal_rj.php", {dari_tanggal:dari_tanggal,sampai_tanggal:sampai_tanggal},function(info){
...
//berdasrkan rm dan tanggal
        ...
        $.post("show_lap_ex_rj.php", {dari_tanggal_ex:dari_tanggal_ex,sampai_tanggal_ex:sampai_tanggal_ex,no_rm_ex:no_rm_ex},function(info){
