...
if ($registrasi_rj['registrasi_rj_lihat']) {
          ...
          echo "<td><button  class='btn btn-warning pilih1' data-id='".$data['id']."' id='panggil-".$data['id']."' data-status='di panggil' data-status_urut='Proses' data-urut='". $data['no_urut']."' data-poli='".$data['poli']."'> Panggil  </button>";
