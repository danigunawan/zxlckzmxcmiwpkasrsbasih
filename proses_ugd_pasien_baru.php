...
$sql6 = $db->prepare("INSERT INTO registrasi (eye,verbal,motorik,alergi,nama_pasien,jam,penjamin,status,
  ...
  gol_darah,status_nikah,pekerjaan_pasien,pengantar_pasien,nama_pengantar,hp_pengantar,alamat_pengantar,keterangan,hubungan_dengan_pasien,dokter) 
  VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");

$sql6->bind_param("ssssssssssssssssssssssssssss",$eye,$verbal,$motorik,$alergi,$nama_lengkap
  ,$jam,$penjamin,$sig_in_ugd,$no_reg,$no_rm,$tanggal_sekarang,$kondisi,$username,$alamat_ktp,$umur
  ,$jenis_kelamin,$rujukan,$ugd_ku,$gol_darah,$status_kawin,$pekerjaan_pasien,$pengantar,$nama_pengantar,$hp_pengantar,$alamat_pengantar,$keterangan,$hubungan_dengan_pasien,$dokter_jaga);
