...
if($imageFileType != "csv") {
    ...
    if (is_uploaded_file($_FILES['csv_pasien']['tmp_name'])) {
        ...
        while (($data = fgetcsv($handle, 4142374, ",")) !== FALSE) {
            ...
            VALUES ('$data[0]','$data[1]','".tanggal_mysql($data['2'])."','$data[3]','$data[4]','$jenis_kelamin')"; //data array sesuaikan dengan jumlah kolom pada CSV anda mulai dari “0” bukan “1”
            //Melakukan Import
