...
<option value="<?php echo $data_penj['dokter'];?>"><?php echo $data_penj['dokter'];?></option>
...
<option ><?php echo $aray['dokter_pengirim'];?></option>
  <?php 
...
<option ><?php echo $data_penj['petugas_lain'];?></option>
  <?php 
