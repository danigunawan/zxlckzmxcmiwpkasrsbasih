...
<div class="col-sm-2 form-group">
  ...
  <input style="height: 20px;" name="no_resep_dokter" type="text" style="height:15px;" id="no_resep_dokter" class="form-control" required="">
</div>

<div class="col-sm-2 form-group">
    <label>Resep Dokter </label><br>
  <input style="height: 20px;" name="resep_dokter" type="text" style="height:15px;" id="resep_dokter" class="form-control" required="">
</div>
