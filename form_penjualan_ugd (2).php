...
<input style="height:17px" type="text" class="form-control"  id="dokter" name="dokter" value="<?php echo $data_reg['dokter']; ?>"readonly=""> 
</div>
...
<option value="">Cari Petugas</option>
 <?php 
    ...
    $query01 = $db->query("SELECT nama FROM user WHERE otoritas = 'Petugas Paramedik'");
...
<div class="row">
 ...
 <div class="col-sm-2">
    ...
    <input style="height:20px;" type="text" class="form-control"  id="penjamin" name="penjamin" placeholder="Penjamin " autocomplete="off" value="<?php echo $data_reg['penjamin']; ?>">   
</div>

 <div class="col-sm-2">
    <label> Asal Poli :</label>
    <input style="height:20px;" type="text" class="form-control"  id="asal_poli" name="asal_poli" placeholder="Isi Poli" autocomplete="off" value="<?php echo $data_reg['poli']; ?>">   
</div>
...
<option value="">Cari Petugas</option>
  <?php 
    ...
    //untuk menampilkan semua data pada tabel pelanggan dalam DB
    $query01 = $db->query("SELECT nama FROM user WHERE otoritas = 'Petugas Farmasi'");
...
<option value="">Cari Petugas</option>
  <?php 
    ...
    //untuk menampilkan semua data pada tabel pelanggan dalam DB
    $query01 = $db->query("SELECT nama FROM user WHERE otoritas = 'Petugas Lain'");
    ...
    <div class="card card-block">
      ...
      <div class="row">
        ...
        <div class="col-sm-6">
           ...
           <input style="height:10px;font-size:15px" type="text" name="biaya_admin" id="biaya_admin" class="form-control" placeholder="Biaya Admin" readonly="" onkeydown="return numbersonly(this, event);" onkeyup="javascript:tandaPemisahTitik(this);">
...
$(document).ready(function(){
  ...
  $("#submit_produk").click(function(){
    ...
    //end hitung pajak
    var total_akhir = parseInt(total_akhier,10) + parseInt(hasil_tax,10);
 ...
 $.post("proses_tbs_penjualan_rj&ugd.php",{penjamin:penjamin,asal_poli:asal_poli,level_harga:level_harga,petugas_paramedik:petugas_paramedik,petugas_farmasi:petugas_farmasi,petugas_lain:petugas_lain,no_reg:no_reg,no_rm:no_rm,dokter:dokter,petugas_kasir:petugas_kasir,kode_barang:kode_barang,nama_barang:nama_barang,jumlah_barang:jumlah_barang,harga:harga,potongan:potongan,tax:tax,satuan:satuan, ber_stok:ber_stok},function(data){
...
alert("Silakan Bayar Piutang");
 ...
 $.post("proses_bayar_jual_kasir.php",{sisa_pembayaran:sisa_pembayaran, kredit:kredit,no_rm:no_rm,no_reg:no_reg,tanggal_jt:tanggal_jt,total:total,total2:total2,potongan:potongan,potongan_persen:potongan_persen,tax:tax,cara_bayar:cara_bayar,pembayaran:pembayaran,total_hpp:total_hpp,harga:harga,kode_gudang:kode_gudang,dokter:dokter,petugas_kasir:petugas_kasir,petugas_paramedik:petugas_paramedik,petugas_farmasi:petugas_farmasi,petugas_lain:petugas_lain,keterangan:keterangan,ber_stok:ber_stok,ppn_input:ppn_input,sisa:sisa,ppn:ppn,penjamin:penjamin,nama_pasien:nama_pasien,jenis_penjualan:jenis_penjualan},function(info) {
...
$(document).ready(function(){
      ...
      if (biaya_admin == "") {
        ...
        var sisa_potongan = (parseInt(total,10) + parseInt(biaya_admin,10)) - potongan_penjualan;

             var t_tax = ((parseInt(sisa_potongan,10) * parseInt(tax,10)) / 100);
             var hasil_akhir = parseInt(sisa_potongan, 10) + parseInt(t_tax,10);

        $("#potongan1").val(tandaPemisahTitik(parseInt(hasil_akhir)));
        $("#total1").val(tandaPemisahTitik(parseInt(hasil_akhir)));
...
if (biaya_admin == "") {
        biaya_admin = 0;
              ...
              var cara_bayar = $("#carabayar1").val();
              var tax = $("#tax").val();
              var t_total = (parseInt(total,10) + parseInt(biaya_admin,10)) - potongan;
